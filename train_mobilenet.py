...
# --- CRITICAL DIFFERENCE ---
# MobileNetV2 also scales to [-1, 1], but we use the official function to be safe.
...
# --- 9. SAVE ---
model.save("waste_mobilenet_3class.keras")
print("Model saved as waste_mobilenet_3class.keras")